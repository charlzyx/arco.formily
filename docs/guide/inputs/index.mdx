...
formily-arco-react 是基于 Ant Design 封装的针对表单场景专业级(Professional)组件库，它主要有以下几个特点：
...
- 更丰富的组件体系
  - 布局组件
    - [FormLayout](/basic/formlayout)
    - [FormItem](/basic/formitem)
    - [FormGrid](/basic/formgrid)
    - [FormButtonGroup](/basic/formbuttongroup)
    - [Space](/basic/space)
    - [Submit](/basic/submit)
    - [Reset](/basic/reset)
  - 输入控件
    ...
    - [Select](/basic/select)
    - [TreeSelect](/basic/treeselect)
    - [DatePicker](/basic/datepicker)
    - [TimePicker](/basic/timepicker)
    - [NumberPicker](/basic/numberpicker)
    - [Transfer](/basic/transfer)
    - [Cascader](/basic/cascader)
    - [Radio](/basic/radio)
    - [Checkbox](/basic/checkbox)
    - [Upload](/basic/upload)
    - [Switch](/basic/switch)
  - 场景组件
    - [ArrayCards](/basic/arraycards)
    - [ArrayItems](/basic/arrayitems)
    - [ArrayTable](/basic/arraytable)
    - [ArrayTabs](/basic/arraytabs)
    - [FormCollapse](/basic/formcollapse)
    - [FormStep](/basic/formstep)
    - [FormTab](/basic/formtab)
    - [FormDialog](/basic/formdialog)
    - [FormDrawer](/basic/formdrawer)
    - [Editable](/basic/editable)
  - 阅读态组件
    - [PreviewText](/basic/previewtext)
- 主题定制能力
...
$ npm install --save @formily/core @formily/react formily-arco-react
